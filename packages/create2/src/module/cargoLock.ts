...
export const cargoLock = ({moduleNameSnakeCase}: {moduleNameSnakeCase: string;}): PatcherFile => ({
...
dependencies = [
 "derive_more",
 "hc_zome${moduleNameSnakeCase}s_types",
 "hdk",
 "serde",
]
...
version = "0.0.5"
source = "registry+https://github.com/rust-lang/crates.io-index"
checksum = "dbac5369262b970c3a966c29502f17689da917678c9d60bdbaa9695d1b1c57fb"
dependencies = [
 "chrono",
 "serde",
 "thiserror",
