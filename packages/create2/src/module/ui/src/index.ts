...
export default ({moduleNamePluralTitleCase, moduleNamePlural, moduleNameSnakeCase, kebabPlural_, _kebab, moduleNameTitleCase, kebabSingular_, moduleName}: {moduleNamePluralTitleCase: string; moduleNamePlural: string; moduleNameSnakeCase: string; kebabPlural_: string; _kebab: string; moduleNameTitleCase: string; kebabSingular_: string; moduleName: string;}): PatcherDirectory => ({
