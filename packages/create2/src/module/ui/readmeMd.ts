...
export const readmeMd = ({packageName, moduleNameSnakeCase, moduleNamePlural}: {packageName: string; moduleNameSnakeCase: string; moduleNamePlural: string;}): PatcherFile => ({
