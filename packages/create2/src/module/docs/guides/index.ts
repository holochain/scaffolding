...
export default ({moduleNameSnakeCase, moduleNamePlural, packageName, moduleNamePluralTitleCase, _kebab, kebabSingular_, moduleName, moduleNameTitleCase, kebabPlural_}: {moduleNameSnakeCase: string; moduleNamePlural: string; packageName: string; moduleNamePluralTitleCase: string; _kebab: string; kebabSingular_: string; moduleName: string; moduleNameTitleCase: string; kebabPlural_: string;}): PatcherDirectory => ({
