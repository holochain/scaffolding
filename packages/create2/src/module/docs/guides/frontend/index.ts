...
export default ({packageName, moduleNamePluralTitleCase, _kebab, kebabSingular_, moduleNamePlural, moduleName, moduleNameSnakeCase, moduleNameTitleCase, kebabPlural_}: {packageName: string; moduleNamePluralTitleCase: string; _kebab: string; kebabSingular_: string; moduleNamePlural: string; moduleName: string; moduleNameSnakeCase: string; moduleNameTitleCase: string; kebabPlural_: string;}): ScDirectory => ({
