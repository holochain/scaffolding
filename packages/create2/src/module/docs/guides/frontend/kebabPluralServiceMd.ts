...
export const kebabPluralServiceMd = ({packageName, moduleNameSnakeCase, moduleNamePluralTitleCase, moduleNameTitleCase}: {packageName: string; moduleNameSnakeCase: string; moduleNamePluralTitleCase: string; moduleNameTitleCase: string;}): PatcherFile => ({
