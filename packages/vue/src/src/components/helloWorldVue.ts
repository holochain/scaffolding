export const helloWorldVue = ({zomeName, fnName, payload, cellRole}: {zomeName: string; fnName: string; payload: string; cellRole: string;}) => `<template>
  <div class="hello">
    <h1>{{ msg }}</h1>
    <p>
...
export default defineComponent({
  ...
  async mounted() {
    ...
    const cellData = info.cell_data.find(data => data.role_id === '${cellRole}') as InstalledCell;
