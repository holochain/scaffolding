...
import { VocabularyWebComponentGenerators } from './types';

const titleCase = (str: string) => upperFirst(camelCase(str));

export function generateCreateTypeWebComponent(
  webComponentGenerators: VocabularyWebComponentGenerators,
  ...
  const imports: NpmImport[] = [
    {
      importSource: '@material/mwc-button',
