...
pub const TRYORAMA_VERSION: &str = "^0.18.0-rc.0";
...
pub const HC_SPIN_VERSION: &str = "^0.500.0-rc.0";
...
pub const HDI_VERSION: &str = "0.6.0-rc.0";

/// crates.io <https://crates.io/crates/hdk/versions>
pub const HDK_VERSION: &str = "0.5.0-rc.0";

/// crates.io <https://crates.io/crates/holochain/versions>
pub const HOLOCHAIN_VERSION: &str = "0.5.0-rc.1";
