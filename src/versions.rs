...
pub const TRYORAMA_VERSION: &str = "^0.17.0-dev.6";

/// npm: <https://www.npmjs.com/package/@holochain/client>
pub const HOLOCHAIN_CLIENT_VERSION: &str = "^0.18.0-rc.0";
...
pub const HDI_VERSION: &str = "0.5.0-rc.1";

/// crates.io <https://crates.io/crates/hdk/versions>
pub const HDK_VERSION: &str = "0.4.0-rc.1";

/// crates.io <https://crates.io/crates/holochain/versions>
pub const HOLOCHAIN_VERSION: &str = "0.4.0-rc.1";
