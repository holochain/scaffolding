...
pub const TRYORAMA_VERSION: &str = "^0.18.0-dev.0";

/// npm: <https://www.npmjs.com/package/@holochain/client>
pub const HOLOCHAIN_CLIENT_VERSION: &str = "^0.19.0-dev.1";
...
pub const HDI_VERSION: &str = "0.6.0-dev.2";

/// crates.io <https://crates.io/crates/hdk/versions>
pub const HDK_VERSION: &str = "0.5.0-dev.4";

/// crates.io <https://crates.io/crates/holochain/versions>
pub const HOLOCHAIN_VERSION: &str = "0.5.0-dev.4";
